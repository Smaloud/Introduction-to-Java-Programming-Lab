...
public class Trainer {
    ...
    public void setActivatePokemon(Pokemon pokemon) {
        this.activatePokemon = pokemon;
    }
    ...
    public Pokemon summon() {
        ...
        if (!check) {
            ...
            return this.getActivatePokemon();
    }
